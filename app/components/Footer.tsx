      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            >
              Bringing the ancient healing powers of roasted bamboo salt to
              modern wellness routines. Proudly crafted in Nepal 🇳🇵.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-300 hover:bg-[#296B46]"
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm flex items-center gap-2 group transition-colors hover:text-[#3a9962]"
                    style={{ color: "rgba(255,255,255,0.55)" }}
                  >
