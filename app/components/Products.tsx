...
import { Weight, Star } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-stone-500 text-lg leading-relaxed">
            Discover the ancient healing power of Nepal Bamboo Salt, roasted to perfection using pine-wood fires.
          </p>
        </div>
              ...
              <div className="flex flex-col flex-1 p-7">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-6 pb-6 border-b border-stone-100">
                    ...
                    <span className="text-sm font-bold text-stone-900">{product.weight}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Link
                    href="/shop"
                    className="flex items-center justify-center gap-2 bg-[#edf7f1] text-[#296B46] border border-[#c6ecd7] py-3 rounded-xl font-bold text-sm hover:bg-[#296B46]/10 transition-all duration-300 active:scale-95"
                  >
                    View in Shop →
                  </Link>
                </div>
        ...
        <div className="text-center mt-12">
          <Link href="/shop" className="inline-flex items-center gap-2 text-[#296B46] font-semibold hover:underline underline-offset-4 text-sm">
