        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-6 -right-4 lg:-right-8 bg-white rounded-2xl shadow-xl p-5 border border-stone-100 max-w-[190px]">
              <div className="text-4xl font-extrabold text-[#296B46] leading-none">
                70+
              </div>
              <div className="text-sm text-stone-500 mt-1 font-medium">
                Essential minerals per serving
              </div>
            </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-stone-500 text-lg mb-10 leading-relaxed">
              For centuries, bamboo salt has been used in traditional holistic
              medicine across Asia. We bring this powerful, mineral-rich
              superfood straight to your table.
            </p>
