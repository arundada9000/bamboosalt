...
export const metadata: Metadata = {
  ...
  description: "Nepal Bamboo Salt Pvt. Ltd. produces premium bamboo salt using eco-friendly, traditional Korean methods combined with pure Himalayan resources.",
};
    ...
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 md:py-32 overflow-hidden bg-[#1b4a30] text-center text-white">
          <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 50%, rgba(41,107,70,0.5) 0%, transparent 70%)" }} />
          ...
          <div className="max-w-4xl mx-auto px-4 relative z-10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
              About <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#f0d49a] to-[#d4a853]">Nepal Bamboo Salt</span> Pvt. Ltd.
            </h1>
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed font-medium">
              We are a Nepal-based company dedicated to producing premium bamboo salt using eco-friendly and traditional techniques.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6 text-lg text-stone-600 leading-relaxed">
                  <p>
                    Inspired by ancient Korean salt-making methods, we proudly combine the pristine nature of Himalayan resources with modern quality standards to create a therapeutic product like no other.
                  </p>
                  <p>
                    Our mission is not just about producing salt; it&apos;s about promoting holistic natural health products while deeply supporting local communities and adhering strictly to sustainable practices. Each grain represents uncompromised purity.
                  </p>
                </div>
                <div className="flex gap-4 pt-4">
                  <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-sm border border-stone-100">
                    ...
                    <div>
                      <span className="block text-sm font-extrabold text-stone-900">Eco-Friendly</span>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 bg-white px-5 py-3 rounded-2xl shadow-sm border border-stone-100">
                    ...
                    <div>
                      <span className="block text-sm font-extrabold text-stone-900">Community</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="bg-white rounded-[2rem] p-10 md:p-14 shadow-lg shadow-[#296B46]/5 border border-white relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <p className="text-xl text-stone-600 leading-relaxed font-medium">
                    To become a <strong className="text-[#296B46]">leading bamboo salt brand</strong> in Nepal and expand our purity to international markets, setting the global standard for natural wellness.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[2rem] p-10 md:p-14 shadow-lg shadow-[#296B46]/5 border border-white relative overflow-hidden group hover:-translate-y-2 transition-transform duration-300">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <p className="text-xl text-stone-600 leading-relaxed font-medium">
                    To deliver <strong className="text-[#296B46]">high-quality, health-focused</strong> salt products with unwavering authenticity, transparency, and trust for every household.
                  </p>
                </div>
              </div>
